...
import type { Category, Difficulty, Language } from "@study-buddy/shared";
...
/**
 * Deck length options for dropdown (common choices)
 */
export const DECK_LENGTH_OPTIONS = [5, 10, 15, 20, 25, 30, 40, 50];
